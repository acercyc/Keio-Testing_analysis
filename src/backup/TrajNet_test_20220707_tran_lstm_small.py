...
wandb_logger = WandbLogger(project="test_20220707", id='tran_lstm_small')
...
class Transformer(nn.Module):
    def __init__(self, nFeature=16, nhead=16, dim_feedforward=32, num_layers=4, dropout=0.1):
...
class TrajNet(nn.Module):
    def __init__(self, nHidden=8, nFeature=16, dropout=0.1):
        super(TrajNet, self).__init__()
        self.nhidden = nHidden
        self.nFeature = nFeature

        # encoding
        self.enc_conv = nn.Conv1d(3, nFeature, 1)
