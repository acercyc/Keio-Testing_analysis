...
wandb_logger = WandbLogger(project="test_20220707", id='tran_tran_xy_tanh_pos8')
...
class TrajNet(nn.Module):
    def __init__(self, nHidden=8, nFeature=64, dropout=0.1):
        ...
        # encoding
        self.enc_conv = nn.Conv1d(2+16, 64, 1)
        ...
        # decode
        self.dec_conv1 = nn.Conv1d(nHidden, 64-16-2, 1)
    ...
    def forward(self, x):
        ...
        # --------------------------------- encoding --------------------------------- #
        x = self.positionEncoding_sincos(x, nDim=8)
