...
wandb_logger = WandbLogger(project="test_20220707", id='tran_lstm_big3_init_pos_nLSTM')
...
class Lstm(nn.Module):
    def __init__(self, nLayer=4, nFeature=16, dropout=0.1):
        super(Lstm, self).__init__()
        self.lstm = nn.LSTM(nFeature, nFeature, nLayer, dropout=dropout, batch_first=True)
