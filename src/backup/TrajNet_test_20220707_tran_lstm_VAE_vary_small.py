...
wandb_logger = WandbLogger(project="test_20220707", id='tran_lstm_VAE_vary_small2')
...
class TrajNet(nn.Module):
    def __init__(self, nHidden=8, nFeature=64, dropout=0.1):
        ...
        # decode
        self.dec_conv1 = nn.Conv1d(nHidden+2, 32, 1)
        self.decoder = Lstm(nFeature=32, dropout=dropout)
        self.dec_conv2 = nn.Conv1d(32, 2, 1)
