...
wandb_logger = WandbLogger(project="test_20220707", id='tran_tran_xy_tanh_small3')
...
class Transformer(nn.Module):
    def __init__(self, nFeature=64, nhead=16, dim_feedforward=32, num_layers=4, dropout=0.1):
