...
config_model = {'nHidden': 16, 'dim_posEnc': 16,
                'nFeature': 64, 'nhead': 8, 'dim_feedforward': 128, 'num_layers': 8, 'dropout': 0.1,
                'nFeature_dec': 64, 'nhead_dec': 8, 'dim_feedforward_dec': 128, 'num_layers_dec': 8, 'dropout_dec': 0.1}
config.update(config_model)

tags = ['16_hidden', 'hidden_loss']
wandb_logger = WandbLogger(project="test_20220711", config=config, tags=tags, group='tran2tran')
